...
28 September 2023
1. Changed naming convention on main file and Log files to match
   CamelCase conventions of supporting files

2. Reworked log code substantially to fix problem of log file
   not cycling each day at midnight.

3. Added MediaManagement Implementation into AJAControl_2.1.c
*/
